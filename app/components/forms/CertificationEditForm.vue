...
// Initialize calendar values from existing certification dates
if (props.certification.start_date) {
  try {
    startDateValue.value = parseDate(props.certification.start_date)
  } catch (e) {
    console.error('Error parsing start date:', e)
  }
}

if (props.certification.end_date) {
  try {
    endDateValue.value = parseDate(props.certification.end_date)
  } catch (e) {
...
const state = reactive<Schema>({
  ...
  noExpiry: !props.certification.end_date, // If no end_date, assume no expiry
